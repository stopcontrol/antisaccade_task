  ...
  function startExperiment() {
    ...
    if (fullscreen) {
      ...
      if (keyboardNotAllowed) {
        ...
        DOM_target.innerHTML = '<div style=""><p>Bitte dr\u00fccke den Button um in den Vollbildmodus zu wechseln.</p><button id="jspsych-fullscreen-btn" class="jspsych-btn">Aufgabe starten</button></div>';
