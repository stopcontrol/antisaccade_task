...
jsPsych.plugins['free-sort'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // default values
    trial.stim_height = trial.stim_height || 50;
    trial.stim_width = trial.stim_width || 50;
...
//      var coords = random_coordinate(trial.sort_area_width + trial.stim_width / 2, trial.sort_area_height + trial.stim_height / 2);
var coords = trial.sort_area_width / 2 + trial.stim_width / 2, 0 + trial.stim_height / 2);
