...
jsPsych.plugins['space-task-aquisition'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // default values
    trial.stim_height = trial.stim_height || 20;
    trial.stim_width = trial.stim_width || 20;
...
*/
  ...
  /*  display_element.innerHTML += '<div '+
    ...
    display_element.innerHTML += '<div '+
      'id="jspsych-free-sort-arena" '+
      'class="jspsych-free-sort-arena" '+
      'style="position: relative; width:'+trial.sort_area_width+'px; height:'+trial.sort_area_height+'px; border:10px solid #444;margin:1em; border-radius: 300px;"'+
      '></div>';
/*
...
*/
    ...
    var x_start_locations = [0,// 0 ,
                            470,//436,//250 + ((Math.sin(30)) * y_center),//(x_center + ((Math.cos(30)) * y_center)),// y_center - Math.sin(30) * y_center,
                            475,//x_center + Math.cos(30) * y_center, //y_center + Math.sin(30) * y_center,
                            252,//x_center,// 2 * y_center, D
                            40,
                            40//251,//x_center - Math.cos(30) * y_center,// y_center + Math.sin(60) * y_center,
                          ];
    ...
    var rand = jsPsych.randomization.repeat([0,1,2,3,4,5], 1);
