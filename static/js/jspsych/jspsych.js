  ...
  function startExperiment() {
    ...
    if (fullscreen) {
      ...
      if (keyboardNotAllowed) {
        ...
        DOM_target.append('<div class = jspsych-instructions-nav><p>Bitte drücke den Button um in den Vollbildmodus zu wechseln</p><button id="jspsych-fullscreen-btn" class="jspsych-btn">Aufgabe starten</button></div>');
