...
Game.Run.prototype = {
  ...
  quitGame: function () {
      ...
      this.game.time.events.add(Phaser.Timer.SECOND, function () {
        endText = this.game.add.text(this.dude.x+400, 100, 'All done!', {'font': '70px Arial', 'fill':'#fff'});
        endText.anchor.x = 0.5
        finalPoints = this.game.add.text(this.dude.x+400, 200, 'You got ' + this.points + ' points', {font:'70px Arial', fill:'#FFFFFF', align:'center'});
