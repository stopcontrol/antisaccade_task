...
Game.Instructions.prototype = {
  ...
  instruct: function (num) {
    if (num == 1) {
          instruct_text = this.game.add.text(this.game.world.centerX-20,460,"In this game, your job is to find\nthe number that will complete each problem.",
      ...
      instruct_text = this.game.add.text(this.game.world.centerX-10,460,"It is just like the previous game,but now\n you have to answer before time runs out.",
              {font: "20px Arial", fill: "#FFFFFF", align: "center"})
              this.nextB = this.add.button(this.game.world.centerX+175, 530, 'next', function () {
                this.game.world.remove(instruct_text)
                this.rmInstructB = true
