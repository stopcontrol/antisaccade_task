...
Game.Instructions.prototype = {
  ...
  instruct: function (num) {
    if (num == 1) {
          ...
          instruct_text = this.game.add.text(this.game.world.centerX+10,460,"When you think you know the answer, \nkey it in on the number pad.",
          {font: "20px Arial", fill: "#FFFFFF", align: "center"})
          this.nextB = this.add.button(this.game.world.centerX+175, 530, 'next', function () {
            this.game.world.remove(instruct_text)
            this.rmInstructB = true
          ...
          instruct_text = this.game.add.text(this.game.world.centerX-5,460,"You will get a coin for each correct answer. \nTry to get as many as possible!",
          {font: "20px Arial", fill: "#FFFFFF", align: "center"})
          this.nextB = this.add.button(this.game.world.centerX+175, 530, 'next', function () {
            this.game.world.remove(instruct_text)
            this.rmInstructB = true
          ...
          this.instruct_text = this.game.add.text(this.game.world.centerX+20,500,"Go ahead and try this problem now.",
          {font: "20px Arial", fill: "#FFFFFF", align: "center"})
