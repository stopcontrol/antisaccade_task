...
Game.Instructions.prototype = {
  ...
  instruct: function (num) {
    if (num == 1) {
          instruct_text = this.game.add.text(this.game.world.centerX-25,460,"In this game, your job is to find the number \nthat completes the addition problem.",
          ...
          this.nextB.scale.setTo(0.5,0.5)
              ...
              instruct_text = this.game.add.text(this.game.world.centerX,460,"When you think you know the answer, \nkey it in on the number pad.",
              {font: "20px Arial", fill: "#FFFFFF", align: "center"})
              this.nextB = this.add.button(this.game.world.centerX+175, 530, 'next', function () {
                this.game.world.remove(instruct_text)
                this.rmInstructB = true
