...
Game.Instructions.prototype = {
  ...
  instruct: function(num) {
    ...
    if (num == 1) {
      ...
      txt = "In this game, you will see three grids\n with multi-colored tiles."
      ...
      this.back_ground = this.makeBox(220,400,500,190)
      txt = "Your job is to say whether the tiles in \nthe two grids on the left are in the same location\n as the tiles in the grid on the right."
      instruct_text = this.game.add.text(this.game.world.centerX+175,425,txt,txt_style)
      instruct_text.anchor.x = (0.5,0.5)
      ...
      this.back_ground = this.makeBox(220,400,500,190)
      txt = "You should ignore the color of the tiles."
      instruct_text = this.game.add.text(this.game.world.centerX+175,425,txt,txt_style)
      instruct_text.anchor.x = (0.5,0.5)
      ...
      this.back_ground = this.makeBox(220,400,500,190)
      txt = "Press the equal button if the locations are the same.\n Press the unequal button if the locations are different.\n Hit next to try this problem now!"
      instruct_text = this.game.add.text(this.game.world.centerX+175,425,txt,txt_style)
      instruct_text.anchor.x = (0.5,0.5)
      this.nextB = this.add.button(475, 525, 'next', function () {
        this.game.world.remove(instruct_text)
